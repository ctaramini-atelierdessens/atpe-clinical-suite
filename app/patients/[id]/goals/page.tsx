    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Objectifs thÃ©rapeutiques â€” {(patient as any).code}</h1>
          {episode ? <p className="mt-2 text-sm text-slate-500">Ã‰pisode : {(episode as any).episode_label}</p> : null}
        </div>
